...
filter_complex+="[w1]crop=$w1:$h1:$x1:$y1,boxblur=10:10[blur1];"  
filter_complex+="[w2]crop=$w2:$h2:$x2:$y2,boxblur=10:10[blur2];"  
filter_complex+="[w3]crop=$w3:$h3:$x3:$y3,boxblur=10:10[blur3];"  
filter_complex+="[w4]crop=$w4:$h4:$x4:$y4,boxblur=10:10[blur4];"  
